...
import com.cd.statussaver.adapter.ShowHomeImagesAdapter;
import com.cd.statussaver.adapter.ShowImagesAdapter;
import com.cd.statussaver.databinding.ActivityFullHomeViewBinding;
...
public class FullHomeViewActivity extends AppCompatActivity {
    private ActivityFullHomeViewBinding binding;
    private FullHomeViewActivity activity;
    private ArrayList<WhatsappStatusModel> fileArrayList;
    private int Position = 0;
    ShowHomeImagesAdapter showImagesAdapter;
    AppLangSessionManager appLangSessionManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_full_home_view);
        activity = this;
        ...
        if (extras != null) {
            fileArrayList= (ArrayList<WhatsappStatusModel>) getIntent().getSerializableExtra("ImageDataFile");
    ...
    public void initViews(){
        showImagesAdapter=new ShowHomeImagesAdapter(this, fileArrayList,FullHomeViewActivity.this);
